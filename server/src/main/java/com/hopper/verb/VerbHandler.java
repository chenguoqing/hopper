...
public interface VerbHandler {
    ...
    /**
     * Processing the received message according to the associated {@link Verb}. All same verbs will use the same
     * instance,so the implementations should guarantee thread-safe.
     */
