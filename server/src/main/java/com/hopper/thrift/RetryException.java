...
public class RetryException extends Exception implements org.apache.thrift.TBase<RetryException, RetryException._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new RetryExceptionStandardSchemeFactory());
   ...
   */
  public RetryException(RetryException other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.period = other.period;
  }

  public RetryException deepCopy() {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RetryException)
      return this.equals((RetryException)that);
    return false;
  }

  public boolean equals(RetryException that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RetryException other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RetryException typedOther = (RetryException)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RetryException(");
    boolean first = true;
  ...
  private static class RetryExceptionStandardSchemeFactory implements SchemeFactory {
    public RetryExceptionStandardScheme getScheme() {
      return new RetryExceptionStandardScheme();
    }
  }

  private static class RetryExceptionStandardScheme extends StandardScheme<RetryException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RetryException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RetryException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RetryExceptionTupleSchemeFactory implements SchemeFactory {
    public RetryExceptionTupleScheme getScheme() {
      return new RetryExceptionTupleScheme();
    }
  }

  private static class RetryExceptionTupleScheme extends TupleScheme<RetryException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RetryException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RetryException struct) throws org.apache.thrift.TException {
