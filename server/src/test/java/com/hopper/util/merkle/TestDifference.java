...
public class TestDifference {
	...
	public void testDiff() {
		...
		TestObject node71 = new TestObject(key7, 13);
		TestObject node81 = new TestObject(key8, 13);
		TestObject node91 = new TestObject(key9, 13);

		node71.setDesc("node 71");
		node71.setStatus(2);

		node81.setDesc("node 81");
		node81.setStatus(2);

		node91.setDesc("node 91");
		node91.setStatus(2);

		TestObject node72 = new TestObject(key7, 13);
		TestObject node82 = new TestObject(key8, 13);
		TestObject node92 = new TestObject(key9, 13);

		node72.setDesc("node 72");
		node72.setStatus(3);

		node82.setDesc("node 82");
		node82.setStatus(3);

		node92.setDesc("node 92");
		node92.setStatus(3);
